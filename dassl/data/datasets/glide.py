...
class Glide(DatasetBase):

    dataset_dir = "deepfake_eval"
    ...
    def _read_data(self, split="train"):
        ...
        data_dirs = [osp.join(self.dataset_dir, "glide_100_27/images/val"), osp.join(self.dataset_dir, "glide_50_27/images/val"), osp.join(self.dataset_dir, "glide_100_10/images/val")]
