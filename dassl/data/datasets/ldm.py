...
class LDM(DatasetBase):
    ...
    def _read_data(self, split="train"):
        ...
        data_dirs = [osp.join(self.dataset_dir, "ldm_100/images/val"), osp.join(self.dataset_dir, "ldm_200/images/val"), osp.join(self.dataset_dir, "ldm_200_cfg/images/val")]
